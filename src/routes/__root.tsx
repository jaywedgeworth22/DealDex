...
export const Route = createRootRoute({
  head: () => ({
    ...
    links: [
      { rel: "icon", href: "/favicon.ico?v=dd-transparent-20260820", sizes: "any" },
      { rel: "icon", type: "image/png", sizes: "32x32", href: "/favicon-32.png?v=dd-transparent-20260820" },
      { rel: "icon", type: "image/png", sizes: "16x16", href: "/favicon-16.png?v=dd-transparent-20260820" },
      { rel: "icon", type: "image/png", href: "/favicon.png?v=dd-transparent-20260820" },
