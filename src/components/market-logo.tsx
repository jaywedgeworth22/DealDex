...
function EbayWordmark({ className }: { className?: string }) {
  return (
    <svg
      ...
      className={cn("h-3.5 w-auto shrink-0 overflow-visible", className)}
    >
...
/** Official Mercari wordmark — blue #5356EE, not the old red character. */
...
export function MarketplaceToggle({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex h-11 items-center gap-2 rounded-full border px-3 transition-[border-color,background-color,box-shadow] duration-150 [&_svg]:size-auto",
        selected
