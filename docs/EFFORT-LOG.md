...
## In Progress
- **2026-08-31 — BF-FIXER — IN PROGRESS — Remove redundant scanner intro and keep eBay/Mercari toggles on one mobile row.**  Branch `codex/mobile-scanner-source-row`, worktree `~/apps/dealdex-codex`, board `128f1e71`.
