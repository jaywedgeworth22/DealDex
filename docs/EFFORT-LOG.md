...
## In Progress
- **2026-08-13 — GROK-BUILD — IN PROGRESS — Scan desk: lock logos, card frame, memory.** Pin wordmarks to a fixed box (they were painting at viewBox size on mobile). Drop grey pills. Thumbs 600×825. Cache last scan + price ticks.
...
- 2026-08-13 — GROK-BUILD reserved scan desk polish (logo box, card frame, memory).
