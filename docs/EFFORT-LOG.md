...
## In Progress
- **2026-08-25 — CURSOR — IN PROGRESS — Android Play + PWA skippable update alerts + standing TestFlight testers.**  Branch `cursor/android-pwa-update-alerts-c953`.  Play In-App Updates on open; PWA reload banner; `testers.json` + fail-soft invite-on-ship.  Keep macos-latest.  No --force-ship.
...
- 2026-08-25 — CURSOR: reserved Android Play + PWA skippable update alerts + standing TestFlight testers (`cursor/android-pwa-update-alerts-c953`).
