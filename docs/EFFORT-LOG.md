...
## In Progress
- **2026-09-04 — GROK — IN PROGRESS — Sentry max-features: iOS profiling + Session Replay (board `af1ab6e9`, branch `grok/sentry-max-features`, worktree `~/apps/dealdex-grok-sentry-max`).**  Web Replay/Feedback already on.  Android hold (existing SDK untouched).  Rollout: `docs/rollouts/2026-09-04-sentry-max-features.md`.
